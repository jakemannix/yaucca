...
class CloudConfig(BaseSettings):
    ...
    sessionstart_tags: str = Field(default="", alias="YAUCCA_SESSIONSTART_TAGS", description="Comma-separated tags to surface as sections at SessionStart (e.g. '@next,@inbox')")
